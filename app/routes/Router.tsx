...
const Router = () => (
  <Switch>
    ...
    <Redirect exact from="/user_variables" to="/variables" />
    <FullPageLayoutRoute path="/user_variables/:id/edit" Component={UserVariableEdit} />
    <FullPageLayoutRoute path="/user_variables/new" Component={UserVariableNew} />
